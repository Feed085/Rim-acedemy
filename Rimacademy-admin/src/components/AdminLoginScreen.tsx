    ...
    <div className="min-h-screen bg-[#F8FAFC] text-gray-900">
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-4 py-10 sm:px-6 lg:px-8">
        <div className="grid w-full max-w-6xl gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="flex flex-col justify-center rounded-[32px] border border-gray-100 bg-white p-8 shadow-2xl shadow-gray-200/60 backdrop-blur-xl sm:p-10 lg:p-14">
            ...
            <h1 className="max-w-xl text-4xl font-black leading-tight text-gray-900 sm:text-5xl">
              Rim Academy
            </h1>
          ...
          <div className="flex items-center justify-center">
            <div className="w-full max-w-md rounded-[32px] border border-gray-100 bg-white p-6 text-gray-900 shadow-2xl shadow-gray-200/60 sm:p-8">
