    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <Modal
        ...
        title={selectedStudent
          ? `${selectedStudent.name} üçün ${assignmentAction === 'assign' ? 'təyinat' : 'geri alma'}`
          : (assignmentAction === 'assign' ? 'Təyinat' : 'Geri alma')}
      >
        <form onSubmit={handleAssign} className="grid grid-cols-2 gap-3 sm:gap-4">
          <div className="col-span-2 space-y-1.5">
            ...
            >
              <option value="course">Kurs {assignmentAction === 'assign' ? 'ver' : 'geri al'}</option>
              <option value="test">Test {assignmentAction === 'assign' ? 'ver' : 'geri al'}</option>
            </select>
          </div>
          <div className="col-span-2 space-y-1.5">
