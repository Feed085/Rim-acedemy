...
export default function Teachers() {
  ...
  const specialties = ['all', 'İngilis dili', 'Rus dili', 'Ərab dili', 'Riyaziyyat', 'Proqramlaşdırma'];
  ...
  const filteredTeachers = teachers.filter(teacher => {
    ...
    const matchesSpecialty = 
      ...
      teacher.specialties.some(s => s.toLowerCase().includes(selectedSpecialty.toLowerCase()));
