...
export default function Footer() {
  ...
  const socialLinks = [
    { icon: TikTokIcon, href: 'https://www.tiktok.com/@rim_academy?_r=1&_t=ZS-95hYNMojWWG', label: 'TikTok', color: 'hover:text-black' },
    { icon: () => (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
    ...
    ), href: 'https://www.instagram.com/rim_academy_?igsh=NnRhaWJzanF4eW40', label: 'Instagram', color: 'hover:text-pink-600' },
    { icon: WhatsAppIcon, href: 'https://wa.me/994516278711', label: 'WhatsApp', color: 'hover:text-green-500' },
  ];
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    to={link.href}
                    className="text-gray-400 hover:text-[#00D084] transition-colors text-sm"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-[#00D084] flex-shrink-0 mt-0.5" />
                <span className="text-gray-400 text-sm">
                  Bakı şəhəri, Nizami rayonu<br />
                  Azərbaycan küçəsi 25
                </span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-gray-400 text-sm">asiman.ismayilov0099@gmail.com</span>
              </li>
              <li className="flex items-center gap-3">
                <Clock className="w-5 h-5 text-[#00D084] flex-shrink-0" />
                <span className="text-gray-400 text-sm">
