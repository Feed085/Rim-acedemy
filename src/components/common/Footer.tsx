...
export default function Footer() {
  ...
  const socialLinks = [
    { icon: TikTokIcon, href: 'https://tiktok.com', label: 'TikTok', color: 'hover:text-black' },
    { icon: () => (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
    ...
    ), href: 'https://instagram.com', label: 'Instagram', color: 'hover:text-pink-600' },
    { icon: WhatsAppIcon, href: 'https://whatsapp.com', label: 'WhatsApp', color: 'hover:text-green-500' },
  ];
